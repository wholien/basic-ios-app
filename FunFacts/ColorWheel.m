...
- (instancetype)init
{
    ...
    if (self) {
        ...
        [UIColor colorWithRed:222/255.0 green:86/255.0 blue:94/255.0 alpha:1.0], //yellow collor
        [UIColor colorWithRed:223/255.0 green:187/255.0 blue:181/255.0 alpha:1.0], //red color
